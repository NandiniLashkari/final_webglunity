...
var ASM_CONSTS = {
  3120656: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3120717: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3120781: function() {return Module.webglContextAttributes.powerPreference;},  
 3120839: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3120894: function($0) {performance.now = function() { return $0; };},  
 3120942: function($0) {performance.now = function() { return $0; };},  
 3120990: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _initializeConvaiClient(apiKey, characterId, enableAudioRecorder, actionConfig, templateKeys) {
          let NDTemplateKeys;
...
var asmLibraryArg = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "getAudioVolume": _getAudioVolume,
  ...
  "strftime": _strftime,
  "toggleAudioVolume": _toggleAudioVolume
};
var asm = createWasm();
/** @type {function(...*):?} */
